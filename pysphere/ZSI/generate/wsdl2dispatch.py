...
class ServiceModuleWriter(object):
    ...
    def setUpImports(self):
        ...
        '''
        i = self.imports
        print('from pysphere.ZSI.schema import GED, GTD', file=i)
        print('from pysphere.ZSI.TCcompound import ComplexType, Struct', file=i)
